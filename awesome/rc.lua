...
awful.screen.connect_for_each_screen(function(s)
	...
	awful.tag.add("", {
		icon               = home .. "/ConfigBackup/awesome/Icons/Awesome Icons/firefox.png",
	...
	awful.tag.add("", {
		icon               = home .. "/ConfigBackup/awesome/Icons/Awesome Icons/terminals.png",
		layout             = awful.layout.suit.tile,
		master_fill_policy = "expand",
		gap_single_client  = true,
		screen             = s,
	...
	awful.tag.add("", {
		icon               = home .. "/ConfigBackup/awesome/Icons/Awesome Icons/folder.png",
		layout             = awful.layout.suit.tile,
		master_fill_policy = "expand",
		gap_single_client  = true,
		screen             = s,
	...
	awful.tag.add("", {
		icon               = home .. "/ConfigBackup/awesome/Icons/Awesome Icons/archive.png",
		layout             = awful.layout.suit.tile,
		master_fill_policy = "expand",
		gap_single_client  = true,
		screen             = s,
	...
	awful.tag.add("", {
		icon               = home .. "/ConfigBackup/awesome/Icons/Awesome Icons/steam.png",
		layout             = awful.layout.suit.tile,
		master_fill_policy = "expand",
		gap_single_client  = true,
		screen             = s,
	...
	awful.tag.add("", {
		icon               = home .. "/ConfigBackup/awesome/Icons/Awesome Icons/spotify2.png",
		layout             = awful.layout.suit.tile,
		master_fill_policy = "expand",
		gap_single_client  = true,
		screen             = s,
	...
	batteryarc_widget({
		...
		arc_thickness = 2,
		charging_color = '#c69df1',
		enable_battery_warning = true,
		bg_color = '#1d1c79',
		timeout = 8,
		size = 20,
		font = 'Hack Nerd Font Bold 8',
		warning_msg_icon = home .. '/ConfigBackup/awesome/Icons/Awesome Icons/aee.jpg',
...
--Calendar-widget (for some reason it was added like this)
...
--This is the end of the calendar_widget
...
{description = "show main menu", group = "awesome"}),
    ...
    awful.key({ modkey, "Control" }, "n",
	      ...
	      -- Prompt
	      awful.key({ modkey, "Shift" },   "b",     function () awful.spawn("flatpak run org.telegram.desktop") end,
	      {description = "runs telegram", group = "launcher"}),
	      awful.key({ modkey, "Shift" },   "p",     function () awful.spawn("java -jar /home/juicy/Documents/PasswordManager.jar") end,
